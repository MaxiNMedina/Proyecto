Rails.application.routes.draw do
    ...
    resources :residences, :auctions, :users, :searches, :hotsales, :reservations, :availabilitys, :settings #para poder acceder a las residencias, subastas, usuarios y busquedas
    resources :users do
  		member do
    		get 'be_premium'
            get 'apply_premium'
